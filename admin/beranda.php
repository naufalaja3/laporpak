    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="pengaduan_masuk.php?cari=semua&carikan=semua" class="nav-link ">
        ...
        <div class="row">
          ...
          <?php
            ...
            <div class="small-box bg-info">
              ...
              <a href="pengaduan_masuk.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          <?php
            ...
            <div class="small-box bg-success">
              ...
              <a href="pengaduan_tanggapi.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <?php
            ...
            <div class="small-box bg-danger">
              ...
              <a href="data_masyarakat.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          <?php
            ...
            <div class="small-box bg-warning">
              ...
              <a href="data_petugas.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <!-- ./col -->
