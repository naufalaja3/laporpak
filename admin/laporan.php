        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            ?>
              ...
              <li class="nav-item has-treeview">
                <a href="laporan.php?cari=semua&carikan=semua" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0 text-dark">Laporan Pengaduan</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    ?>
                    <a href="print.php?cari=<?php echo $cari ?>&&carikan=<?php echo$carikan?>" class="btn btn-primary" target="_blank">
