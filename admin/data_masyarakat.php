            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        ?>
                            ...
                            <li class="nav-item has-treeview">
                                <a href="data_masyarakat.php" class="nav-link active">
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <a href="print_masyarakat.php" class="btn btn-primary" target="_blank">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="hapus_masyarakat.php?nik=<?php echo $data['nik']; ?>" class="badge badge-danger" title="Hapus" onclick="return <?php echo 'confirm(\'Yakin ingin menghapus data ini?\');' ?>"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
