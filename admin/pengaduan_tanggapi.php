      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item has-treeview">
              <a href="pengaduan_tanggapi.php" class="nav-link active">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-12">
              <h1 class="m-0 text-dark">Sudah Ditanggapi</h1>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($koneksi, "SELECT * FROM pengaduan,tanggapan WHERE tanggapan.id_pengaduan=pengaduan.id_pengaduan ");
                    $no = 1;
                              ...
                              ?>
                                <div class="modal-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="tgl_tanggapan" value="<?php echo date("Y-m-d"); ?>" placeholder="Masukan Tanggal">
                                  </div>
                                  <div class="form-group">
                                    <label>Judul_laporan</label>
                                    <input type="text" class="form-control" hidden="hidden" name="nik" value="<?php echo $row['nik']; ?>" readonly>
                                  ...
                                  <div class="form-group">
                                    <label>foto</label>
                                    <label><img src="../dist/img/<?php echo $row['foto']; ?>" alt="tidak ada foto" width="300px"></label>
                                  </div>
                                  <div class="form-group">
                                    <label>Tanggapan</label>
                                    <input type="text" class="form-control" name="tanggapan" placeholder="Masukan tanggapan" required="required">
                                  </div>
