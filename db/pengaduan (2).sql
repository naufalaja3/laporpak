...
CREATE TABLE `pengaduan` (
  ...
  `nik` char(15) NOT NULL,
  `jenis_laporan` enum('lingkungan','kriminalitas','jalan') NOT NULL,
...
(3, 'Naufal ', 'admin', 'password', '00898756', 'admin');
...
--
ALTER TABLE `pengaduan`
  MODIFY `id_pengaduan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=71;
